...
namespace Wifi.Playlist.FormsUI
{
    ...
    {
        private CoreTypes.IPlaylist _playlist;
        ...
        private async void MainForm_Load(object sender, EventArgs e)
        {
            ...
            await _currentWeatherService.SetGeoLocationAsync("Frastanz", "AT");
        ...
        private void addToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            //openFileDialog.Filter = CreateFilter(_playlistItemFactory.AvailableTypes);

            SetupFileDialog(openFileDialog, "Select Item", string.Empty, true, _playlistItemFactory.AvailableTypes);
        ...
        {
            SetupFileDialog(saveFileDialog1, "Save playlist as", _playlist.Name,
        ...
        {
            SetupFileDialog(openFileDialog,"Select Playlist","",false, _repositoryFactory.AvailableTypes);
